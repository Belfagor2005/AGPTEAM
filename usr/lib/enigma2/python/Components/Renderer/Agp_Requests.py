...
USER_AGENTS_2025 = [
    ...
    UserAgent(
        ua="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/537.36 OPR/106.0.0.0",
        weight=2.0),

    # Mobile — Chrome su Android
    UserAgent(
        ua="Mozilla/5.0 (Linux; Android 14; SM-Galaxy) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Mobile Safari/537.36",
        weight=10.0),
    ...
    UserAgent(
        ua="Mozilla/5.0 (Linux; Android 14; SM-Galaxy) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Mobile Safari/537.36 SamsungBrowser/23.0",
        weight=1.0),
]
