        ...
        while (bw):
            ...
            if bw.find("eth") != -1:
                ...
                if self.lanreceivetotal > 0:
                    self.lanreceive = float(
                        newlanreceive - self.lanreceivetotal) * 8 / 1024
                    self.lanreceivemb = float(
                        newlanreceive - self.lanreceivetotal) / 1024
                else:
                    self.lanreceive = 0
                ...
                if self.lantransmittotal > 0:
                    self.lantransmit = float(
                        newlantransmit - self.lantransmittotal) * 8 / 1024
                    self.lantransmitmb = float(
                        newlantransmit - self.lantransmittotal) / 1024
                else:
                    self.lantransmit = 0
                ...
                if (self.lantransmittotal + self.lanreceivetotal) == 0:
                    flaglan = 0
            if (bw.find("ra") != -1) or (bw.find("wlan")
                                         != -1) or (bw.find("wifi") != -1):
                flagwlan = 1
                sp = bw.split(":")
                bw = sp[1].lstrip()
                ...
                if self.wlanreceivetotal > 0:
                    self.wlanreceive = float(
                        newwlanreceive - self.wlanreceivetotal) * 8 / 1024
                    self.wlanreceivemb = float(
                        newwlanreceive - self.wlanreceivetotal) / 1024
                else:
                    self.wlanreceive = 0
                ...
                if self.wlantransmittotal > 0:
                    self.wlantransmit = float(
                        newwlantransmit - self.wlantransmittotal) * 8 / 1024
                    self.wlantransmitmb = float(
                        newwlantransmit - self.wlantransmittotal) / 1024
                else:
                    self.wlantransmit = 0
...
# if ((flaglan == 1) and (flagwlan == 0)) or ((flaglan == 1) and (flagwlan
# == 1)):
        if flaglan == 1:
